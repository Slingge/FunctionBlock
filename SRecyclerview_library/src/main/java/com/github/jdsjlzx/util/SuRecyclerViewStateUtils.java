 ...
 * @time 16/9/10 09:56
 */
public class SuRecyclerViewStateUtils {
    ...
    public static void setFooterViewState(Activity instance, RecyclerView recyclerView, int pageSize, LoadingFooter.State state, View.OnClickListener errorListener) {
        ...
        if (SuRecyclerViewAdapter.getInnerAdapter().getItemCount() < pageSize) {
            return;
        }
        ...
        if (SuRecyclerViewAdapter.getFooterViewsCount() > 0) {
            footerView = (LoadingFooter) SuRecyclerViewAdapter.getFooterView();
    ...
    public static void setFooterViewState2(Activity instance, RecyclerView recyclerView, int pageSize, LoadingFooter.State state, View.OnClickListener errorListener) {
        ...
        if (SuRecyclerViewAdapter.getFooterViewsCount() > 0) {
            ...
            SuRecyclerViewAdapter.addFooterView(footerView);
            recyclerView.scrollToPosition(0);
        }
    }
    ...
    public static LoadingFooter.State getFooterViewState(RecyclerView recyclerView) {
        ...
        RecyclerView.Adapter outerAdapter = recyclerView.getAdapter();
        if (outerAdapter != null && outerAdapter instanceof SuRecyclerViewAdapter) {
            if (((SuRecyclerViewAdapter) outerAdapter).getFooterViewsCount() > 0) {
                LoadingFooter footerView = (LoadingFooter) ((SuRecyclerViewAdapter) outerAdapter).getFooterView();
