...
public class TabFragment4 extends LazyFragment {
    ...
    private String des[] = {"su-35", "EVA-01", "COD10", "su-30", "Asuka", "KO Kotobuki Tsumugi", "寒霜3", "破 Asuka"
            , "Eva-01", "Z1", "COD6"};

    private int resId[] = {R.drawable.ic_item1, R.drawable.ic_item5, R.drawable.ic_item3,
            R.drawable.ic_item6, R.drawable.ic_item2, R.drawable.ic_item8, R.drawable.ic_item4, R.drawable.ic_item9, R.drawable.ic_item11,
            R.drawable.ic_item10, R.drawable.ic_item7,};
