...
public class TabFragment5 extends LazyFragment {
    ...
    private String des[] = {"Asuka", "KO Kotobuki Tsumugi", "su-35"
            , "su-30", "破 Asuka", "Eva-01", "EVA-01", "COD10", "Z1", "COD6", "寒霜3"};

    private int resId[] = {R.drawable.ic_item5, R.drawable.ic_item2, R.drawable.ic_item4,
             R.drawable.ic_item7, R.drawable.ic_item8, R.drawable.ic_item1,R.drawable.ic_item9, R.drawable.ic_item6,
            R.drawable.ic_item10, R.drawable.ic_item3, R.drawable.ic_item11,};
