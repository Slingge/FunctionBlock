...
public class TabFragment3 extends LazyFragment {
    ...
    private String des[] = {"破 Asuka", "寒霜3", "EVA-01", "Eva-01", "Asuka",
            "su-30", "KO Kotobuki Tsumugi", "su-35", "Z1", "COD10", "COD6"};

    private int resId[] = {R.drawable.ic_item3, R.drawable.ic_item4, R.drawable.ic_item7,
            R.drawable.ic_item5, R.drawable.ic_item8, R.drawable.ic_item1,
            R.drawable.ic_item9, R.drawable.ic_item10, R.drawable.ic_item6, R.drawable.ic_item11, R.drawable.ic_item2,};
