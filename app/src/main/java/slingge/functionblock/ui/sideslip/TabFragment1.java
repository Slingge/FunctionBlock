...
public class TabFragment1 extends LazyFragment {
    ...
    private String des[] = {"寒霜3", "EVA-01",  "Eva-01","KO Kotobuki Tsumugi", "破 Asuka", "su-35"
            , "su-30", "Z1", "COD10", "Asuka", "COD6"};

    private int resId[] = { R.drawable.ic_item6,R.drawable.ic_item1,   R.drawable.ic_item10,R.drawable.ic_item3, R.drawable.ic_item4, R.drawable.ic_item2,
            R.drawable.ic_item7, R.drawable.ic_item5, R.drawable.ic_item8, R.drawable.ic_item9,
